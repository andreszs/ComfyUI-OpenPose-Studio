...
![Mão selecionada com controles de transformação e edição](../locales/en/openpose-studio-hand-tools-2.png)
...
![Editor focado de keypoints da mão](../locales/en/openpose-studio-hand-editor-2.png)
