...
![Выбранная рука с элементами управления трансформацией и редактированием](../locales/en/openpose-studio-hand-tools-2.png)
...
![Отдельный редактор keypoints руки](../locales/en/openpose-studio-hand-editor-2.png)
